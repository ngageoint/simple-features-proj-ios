...
Run tests from Xcode or from command line:
    ...
    xcodebuild test -workspace 'sf-proj-ios.xcworkspace' -scheme sf-proj-ios -destination 'platform=iOS Simulator,name=iPhone 12'
...
Pull from [CocoaPods](https://cocoapods.org/pods/sf-proj-ios):
    ...
    pod 'sf-proj-ios', '~> 5.0.1'

Pull from GitHub:

    pod 'sf-proj-ios', :git => 'https://github.com/ngageoint/simple-features-proj-ios.git', :branch => 'master'
    pod 'sf-proj-ios', :git => 'https://github.com/ngageoint/simple-features-proj-ios.git', :tag => '5.0.1'
